...
const targetOptionGroups = [
  {
    ...
    items: [
      ...
      { value: 'personalTyp',               label: 'Personaltyp' },
      { value: 'anrede',                    label: 'Anrede' },
      { value: 'titel',                     label: 'Titel' },
      { value: 'amtsbezeichnung',           label: 'Amtsbezeichnung' },
  ...
  },
  {
    ...
    items: [
      ...
      { value: 'emailDienstlich',  label: 'E-Mail dienstlich' },
      { value: 'emailPrivat',      label: 'E-Mail privat' },
    ],
  },
  {
    label: 'Sonstiges',
    items: [
      { value: 'istSichtbar',                label: 'Sichtbar' },
      { value: 'istRelevantFuerStatistik',   label: 'Relevant für Statistik' },
    ],
  },
]
